...
2. **TikTok reliability (Rank 4 KEEP — still under observation)** — Guided smoke verified patterns A/B/D and correct terminal Slack after final attempt; continue monitoring (incl. attempt-3 recovery). Early `/photo/` rejection remains a separate follow-up. Do not treat TikTok as fully solved.
