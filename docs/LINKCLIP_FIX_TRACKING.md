...
| F6 | Background final-file download | Medium | Open | Backend job can continue; final file download/save still needs foreground screen. May need DownloadManager / Foreground Service later. | 2026-07-20 | Out of current Phase 1 ops |
