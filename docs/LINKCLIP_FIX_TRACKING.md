...
| Perf | Download timing | Medium | Partially Done | Safe `[Perf][Download]` / `[Perf][MobileDownload]` stage timers added (analyze, queue, yt-dlp, ffmpeg, cache, save). Benchmark via `docs/LINKCLIP_DOWNLOAD_PERFORMANCE.md`. No yt-dlp/ffmpeg optimizations yet. | 2026-07-23 | Measure before optimize |
